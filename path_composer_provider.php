 ...
 * @package redaxo\core
 */
class rex_path_composer_provider
{
    /**
     * @var string
     */
    ...
    const TO_ORIGINAL_PATH = 'vendor/redaxo/source/';
    ...
    {
        if ($this->provideAbsolutes) {
            return __DIR__ . '/' . self::TO_ORIGINAL_PATH . $file;
        }

        return '/' . self::TO_ORIGINAL_PATH . $file;
    }
    ...
    {
        if ($this->provideAbsolutes) {
            return __DIR__ . '/' . self::TO_ORIGINAL_PATH . $this->backend . '/' . $file;
        }

        return self::TO_ORIGINAL_PATH . $this->backend . '/' . $file;
    }
    ...
    {
        return $this->base('redaxo/index.php');
    }
    ...
    {
        if ($this->provideAbsolutes) {
            return __DIR__ . '/redaxo/data/' . $file;
        }

        return '/redaxo/data/' . $file;
    }
